...
<body>
	<table id="dg" title="Custom DataGrid Pager" style="width:100%;height:100%"
		...
		<thead>
			<div > 班级 <input id="vv" class="easyui-validatebox" />  &nbsp &nbsp
				 姓名 <input id="vv" class="easyui-validatebox" />  &nbsp &nbsp
				 电话号码 <input id="vv" class="easyui-validatebox" />  &nbsp &nbsp
